...
<img src="./src/images/token-name.png" width=1000 height=1000/>

This step is the entry point, and the user can create his token name.

# Token Symbol

<img src="./src/images/token-symbol.png" width=1000 height=800/>

In this step, the user can create his token Symbol.

# Token Distribution

<img src="./src/images/token-distribution.png" width=1000 height=800/>

In this step, the user can can set how he is going to share his assets between players.

# Select Chain

<img src="./src/images/select-chain.png" width=1000 height=800/>

This step is the final step and the user can select which Blockchain he wants to use.

# Token Resume

<img src="./src/images/token-resume.png" width=1000 height=800/>
