...
<img src="./src/images/token-name.png" width=2552 height=1225/>

This step is the entry point, and the user can create his token name.

# Token Symbol

<img src="./src/images/token-symbol.png" width=2552 height=1225/>

In this step, the user can create his token Symbol.

# Token Distribution

<img src="./src/images/token-distribution.png" width=2552 height=1225/>

In this step, the user can can set how he is going to share his assets between players.

# Select Chain

<img src="./src/images/select-chain.png" width=2552 height=1225/>

This step is the final step and the user can select which Blockchain he wants to use.

# Token Resume

<img src="./src/images/token-resume" width=2552 height=1225/>
